...
void moveSnake(Snake *snake) {
    ...
    switch (snake->direction) {
        case 0: snake->body[0].y--; break;  // Moves up
        case 1: snake->body[0].x++; break;  // Moves right
        case 2: snake->body[0].y++; break;  // Moves down
        case 3: snake->body[0].x--; break;  // Moves left
